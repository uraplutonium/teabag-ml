...
public class HQCScoreFunction implements BNScoreFunction {

    @Override
    public double getScore(Queryable dataset, BayesNet bayesNet) {
	// System.out.println("calculating HQC score for bayesnet \"" + bayesNet.getName() + "\" on the dataset with " + dataset.getDimension() + " attributes...");
	...
	penalisation = penalisation*Math.log(Math.log(dataset.getDataSize()));

	// System.out.println("HQC score calculated.");
	...
	// System.out.println("HQC: " + (bicScore - penalisation));
